...
Original file is located at
    https://colab.research.google.com/drive/1_FdyhxhYrdwaypWoGIDv3TUxHUERGpYq
"""
...
# Load dataset
file_path = r'D:\Courses\IBM Data Scientist\Graduation project\2\cleaned_dataset.csv'
try:
    df = pd.read_csv(file_path)
except FileNotFoundError:
    st.error(f"File not found. Please verify the file path: {file_path}")
...
# Since your dataset has 'Male' and 'Female' as strings, no mapping is needed.
selected_genders = st.sidebar.multiselect('Select Gender',
                                           options=df['sex'].unique(),  # Extract unique values directly from the column
                                           default=df['sex'].unique())  # Default to showing all genders
...
st.sidebar.download_button(
    ...
    mime='text/csv'  # Ensure MIME type is specified
)